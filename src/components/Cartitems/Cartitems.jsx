...
const CartItem = (props) => {
    ...
    useEffect(() => {
        const findDetail = product.filter(p => p.id === productId)[0];
  ...
  return (
    <div className='flex justify-between items-center bg- text-white p-2 border-b-2 border-slate-700 gap-5 rounded-md'>
